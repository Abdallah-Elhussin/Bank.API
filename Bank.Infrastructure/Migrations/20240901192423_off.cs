        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreaetAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clinets_Accounts_AccountID",
                        column: x => x.AccountID,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clinets_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Clinets_Sexs_SexId",
                        column: x => x.SexId,
                        principalTable: "Sexs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clinets_Street_StreetId",
                        column: x => x.StreetId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "7D9B7113-A8F8-4035-99A7-A20DD400F6A3", null, "Clinet", "CLINET" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "B22698B8-42A2-4115-9631-1C2D1E2AC5F7", 0, "efb8f7f5-b9e6-406f-bdee-55d80555daee", "Admin@Admin.com", true, false, null, "ADMIN@ADMIN.COM", "ADMIN", "AQAAAAIAAYagAAAAEEg8ay+XGXp/C6VWqVkMBgGvZfleZz8Ww2RoCj8soZ4nsU+dfkjlhl2PPXdMkOs6BQ==", null, false, "a569ea9c-2a17-4206-a5fd-95d8e1c8b04a", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinets_AccountID",
                table: "Clinets",
                column: "AccountID");

            migrationBuilder.CreateIndex(
                name: "IX_Clinets_AppUserId",
                table: "Clinets",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Clinets_SexId",
                table: "Clinets",
                column: "SexId");

            migrationBuilder.CreateIndex(
                name: "IX_Clinets_StreetId",
                table: "Clinets",
                column: "StreetId");
